...
def _build_run(
    ...
    *,
    ...
    settings = {
        ...
        "autotune_target_metric": request.autotune_target_metric,
        "autotune_target_value": request.autotune_target_value,
        "autotune_max_rounds": request.autotune_max_rounds,
        "autotune_time_budget_seconds": request.autotune_time_budget_seconds,
        "autotune_patience": request.autotune_patience,
        "autotune_class_balance": request.autotune_class_balance,
